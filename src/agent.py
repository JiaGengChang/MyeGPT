...
- **exome_ns_variants**: Non-synonymous exome variants, indexed by Gene symbol "GENE" and Ensemble stable ID "GENEID". The column number, name, and description are as follow:\n{exome_ns_variants_schema}
