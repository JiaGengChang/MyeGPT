...
- **exome_ns_variants**: Non-synonymous exome variants, indexed Ensemble stable ID "GENEID" and patient identifier "PUBLIC_ID". The column number, name, and description are as follow:\n{exome_ns_variants_schema}
